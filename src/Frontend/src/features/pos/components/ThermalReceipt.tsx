      ...
      <>
        <style>{`
          ...
          @media print  {
            ...
            html, body { width: 100% !important; margin: 0 !important; padding: 0 !important; background: #fff !important; color: #000 !important; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
            body * { visibility: hidden; }
            .pos-receipt { visibility: visible !important; position: relative !important; width: 72mm !important; max-width: 72mm !important; margin: 0 auto !important; padding: 0 2mm !important; background: #fff; color: #000; }
            .pos-receipt * { visibility: visible !important; font-weight: 800 !important; color: #000 !important; }
          }
        `}</style>

        <div ref={ref} className="pos-receipt" style={{ width: '72mm', maxWidth: '72mm', margin: '0 auto', padding: '0 2mm', fontFamily: 'Arial, sans-serif', color: '#000', background: '#fff', fontSize: '11.5px', lineHeight: '1.25', fontWeight: 800 }}>

          {/* ── HEADER ── */}
          <div style={{ textAlign: 'center', fontWeight: 900, fontSize: '17px', marginTop: '0', paddingTop: '0' }}>{STORE.nameTamil}</div>
